        ...
        <form method="post" @submit.prevent="submitData"><!-- Form for entering the Invoicing details -->
            <div class="table-responsive">
                <table class="table table-binvoiceed">
                    <tr>
                        <td colspan="2" align="center"><h2 style="margin-top:10.5px">Update Invoice: {{ invoice.number
                            }}</h2></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" v-model="invoice.client" id="client_name"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" v-model="invoice.number" id="invoice_number"
                                                   class="form-control" placeholder="Invoice Number"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="col-form-label-sm">Invoice Date</label>
                                        </div>
                                        <div class="col-md-6">
...
<script>
    ...
    export default {
        ...
        created() { // Set the initial defaults when the current component is created
        ...
        methods: {
            ...
            submitData() { // Create a new invoice variable, set the properties and submit the same for data insertion
                let newInvoice = {
            ...
            updateInvoice(invoice) { // Submit to Data to the remove server for data insertion
                let vm = this;
